...
bl_info = {
    "name": "BeautyDrive OBJ Format",
    "author": "Lukas Straub",
    "version": (0, 1, 1),
    "blender": (0, 1, 1),
    "location": "File > Import-Export",
    "description": "Import-Export BeautyDrive",
    "warning": "",
...
class ImportOBJ(bpy.types.Operator, ImportHelper, IOOBJOrientationHelper):
    ...
    bl_idname = "import_scene.beautydrive"
    bl_label = "Import BeautyDrive"
...
class ExportOBJ(bpy.types.Operator, ExportHelper, IOOBJOrientationHelper):
    ...
    bl_idname = "export_scene.beautydrive"
    bl_label = 'Export BeautyDrive'
    bl_options = {'PRESET'}
...
def menu_func_import(self, context):
    self.layout.operator(ImportOBJ.bl_idname, text="BeautyDrive (.obj)")


def menu_func_export(self, context):
    self.layout.operator(ExportOBJ.bl_idname, text="BeautyDrive (.obj)")
